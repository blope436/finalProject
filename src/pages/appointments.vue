...
<div class="mx-auto text-red-700 border-8 border-gray-500 bg-blue-400">
    <form @submit.prevent="submitButton" class="text-center text-xl space-x-3 space-y-4 py-7">
        ...
        <input required id="phonenumbers" type="tel" pattern="\d*" maxlength="10" title="You must enter numbers only- No special characters or letters - Max 10 characters" class="rounded-lg border-4" placeholder="Phone: 1111111111" v-model="phonenumber"/>
